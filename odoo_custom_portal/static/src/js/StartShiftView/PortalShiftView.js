...
export class PortalShiftView extends Component {
    ...
    setup() {
        ...
        useBus(this.env.bus, "ACTION_MANAGER:UI-UPDATED", (mode) => {
            ...
            // $('.o_gantt_view.o_planning_gantt').click(function () {
            //     console.log('cunt')
            //     alert("Handler for .click() called.");
            // });
        });
        // useBus(this.env.bus, "WEB_CLIENT_READY", (mode) => {
        //     console.log('cunt')
        //     // if (mode !== "new") {
        //     //     this.el.classList.toggle("o_fullscreen", mode === "fullscreen");
        //     // }
...
PortalShiftView.template = "odoo_custom_portal.PortalShiftView"
PortalShiftView.components = {ActionContainer, ErrorHandler, NotUpdatable, MainComponentsContainer};
